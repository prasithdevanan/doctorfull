        ...
        <>
            {
                ...
                (
                    <>
                                        ...
                                        <>
                                            ...
                                            <div className="relative">
                                                ...
                                                <button
                                                    ...
                                                    className="relative z-30 flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-full border border-(--color-primary)/10 bg-(--color-primary)/10 text-sm font-semibold text-(--color-primary) transition-colors duration-200 hover:bg-(--color-primary)/15 cursor-pointer"
                                                >
                                                    {slice}
                                                </button>
                                                ...
                                                {openMenu && (
                                                    <>
                                                        ...
                                                        {/* Dropdown */}
                                                        <div className="absolute right-0 top-full z-[70] mt-2 w-52 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-[0_8px_25px_rgba(15,23,42,0.10)]">
                                                            ...
                                                            <button
                                                                ...
                                                                className="flex w-full items-center gap-3 px-4 py-3 text-left text-sm text-slate-600 transition-colors hover:bg-slate-50 hover:text-slate-900 cursor-pointer"
                                                            >
                                                                <i className="bi bi-person text-base text-(--color-primary)" />
                                                            ...
                                                            <button
                                                                ...
                                                                className="flex w-full items-center gap-3 px-4 py-3 text-left text-sm text-slate-600 transition-colors hover:bg-slate-50 hover:text-slate-900 cursor-pointer"
                                                            >
                                                                <i className="bi bi-calendar-check text-base text-(--color-primary)" />
                                                            ...
                                                            <button
                                                                ...
                                                                className="flex w-full items-center gap-3 px-4 py-3 text-left text-sm text-red-500 transition-colors hover:bg-red-50 cursor-pointer"
                                                            >
                        ...
                        {menu && (
                            <div className={`fixed w-60 right-0 top-0 h-full transform transition-transform duration-500 ease-in-out z-100 ${menu ? "translate-x-0" : "translate-x-full"}`}>
                                            ...
                                            <div className="flex flex-col gap-1 justify-center items-center">
                                                ...
                                                {navItems.map((item, index) => (
                                                    <NavLink
                                                        ...
                                                        onClick={() => setMenu(false)}
                                                        className={({ isActive }) =>
                                                            `px-14 py-3 rounded-lg text-sm font-medium transition-colors duration-150 ${isActive
