        ...
        <>
            {
                newFilter.length === 0 ?
                    ...
                    :
                    < div className={` ${isHome ? 'flex overflow-scroll gap-6 px-6 py-4 justify-baseline lg:justify-center' : 'grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 px-6 gap-6'}`}>
                        {
