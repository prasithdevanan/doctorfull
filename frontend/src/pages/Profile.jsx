...
function Profile() {
  ...
  return (
    <>
      ...
      {loading ?
        (<div className='w-full h-[calc(100vh-120px)] flex items-center justify-center flex-col gap-2' >
          <div className='w-12 h-12 rounded-full border-t-4 border-b-4 border-dashed border-(--color-primary) animate-spin'>
          </div>
