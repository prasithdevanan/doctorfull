...
function Appoiment() {
  ...
  return (
    <section className="h-[calc(100vh-56px)] w-full px-4 py-6 bg-gray-50 overflow-y-auto">
        ...
        <>
          ...
          <div className="grid gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {appointments.map((item, index) => (
              ...
              ${item?.status === "Completed"
                ...
                {/* Action Button */}
                <button className="mt-4 w-full py-2 rounded-xl bg-blue-600 text-white font-medium hover:bg-blue-700 transition cursor-pointer">
                  View Details
                </button>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-10">
            ...
            <button
              ...
              disabled={page === 1}
              className="w-full sm:w-auto px-6 py-2 rounded-xl bg-gray-200 text-gray-700 hover:bg-gray-300 transition disabled:opacity-50 cursor-pointer"
            >
              ← Prev
            </button>
            ...
            <button
              ...
              className="w-full sm:w-auto px-6 py-2 rounded-xl bg-blue-600 text-white hover:bg-blue-700 transition disabled:opacity-50 cursor-pointer"
            >
              Next →
            </button>
